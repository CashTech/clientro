...
# installation guide
execute this in repo folder:
```
pip install dist/betfairlightweight-1.7.2.tar.gz
```

Have the certificates in the path from where the code that calls the library is executed.
